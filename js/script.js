...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function promptForNameAndEmail() {
        ...
        `,
            ...
            if (result && result.dismiss !== "cancel") {
                ...
                const finalName = name || "Mr Sai Ram ";
                const finalEmail = email || "nsairam@gmail.com";
    ...
    if (
        preferences.name === "Sai Ram" &&
        preferences.email === "nsairam@gmail.com"
    ) {
